                ...
                <div className="grid grid-cols-3 gap-0 border-b border-[#e7ebf1] pb-6">
                    ...
                    <div className="border-r border-[#e7ebf1] pr-6">
                        <div className="flex items-center gap-1.5">
                            ...
                            <span className="inline-flex h-[18px] w-[18px] items-center justify-center rounded-full border border-[#c5cdd9] text-[10px] font-semibold text-[#9aa6b8]">
                                i
                            </span>
                        </div>
    ...
    return (
        <div className="py-3">
            ...
            <div className="flex items-baseline gap-1.5">
                <span className="text-[15px] font-bold text-[#1681e4]">
                    {pages}
                </span>
                <span className="text-[13px] font-medium text-[#5b6a83]">
                    pages
            ...
            <div className="mx-auto max-w-[1030px]">
                ...
                <div className="relative z-20 -mb-px mt-7 flex w-full items-end overflow-x-auto px-1 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:'none'] [scrollbar-width:none]">
                        ...
                        projects.map((p, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        <button
                                            ...
                                            className="flex items-center gap-2 rounded-full border-2 border-[#2563eb] bg-white px-5 py-1.5 text-[14px] font-semibold text-[#2563eb] transition-all"
                                        >
                                            {iconNode}
                                        ...
                                        <svg
                                            className={`absolute -left-4 w-4 h-4 ${index === 0 ? "-bottom-[2px]" : "bottom-0"}`}
                                            viewBox="0 0 16 16"
                                            fill="none"
                            ...
                            return (
                                <button
                                    ...
                                    className="z-10 mx-1 mb-1.5 inline-flex h-[42px] shrink-0 items-center gap-2 rounded-full bg-[#eef2f9] px-5 text-[14px] font-medium text-[#334155] transition-colors hover:bg-[#e2e8f0] first:ml-0"
                                >
                                    {iconNode}
                                    <span className="max-w-[190px] truncate whitespace-nowrap">
                                        {p.PROJECT}
                    ...
                    {empty && !projectsLoading && (
                        <div className="z-10 mx-1 mb-1.5 inline-flex h-[42px] shrink-0 items-center gap-2 rounded-full bg-[#eef2f9] px-5 text-[14px] font-medium text-[#334155]">
                    ...
                    {!empty && !projectsLoading && !showAddProject && (
                        <button
                            ...
                            className="z-10 ml-1 mr-4 mb-1.5 inline-flex h-[42px] shrink-0 items-center gap-2 rounded-full bg-[#eef2f9] px-5 text-[14px] font-medium text-[#334155] transition-colors hover:bg-[#e2e8f0] sm:mr-0"
                        >
                            <IconPlusCircle className="h-[18px] w-[18px]" />
                            <span className="lowercase">project</span>
                        </button>
                    )}
                    {!empty && !projectsLoading && showAddProject && (
                        <div className="z-20 ml-1 mb-1.5 inline-flex h-[42px] shrink-0 items-center gap-2 rounded-full border-2 border-[#3f4acf] bg-white px-3">
                            <input
                                value={urlInput}
