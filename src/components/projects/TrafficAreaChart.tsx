...
export function TrafficAreaChart({ data }: { data: TrafficPoint[] }) {
  ...
  return (
    <div className="relative w-full">
      ...
      <div className="pointer-events-none absolute right-0 top-0 flex h-30 flex-col justify-between py-1 text-right text-[11px] font-medium tabular-nums text-[#8f97a8]">
